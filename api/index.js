...
// src/server/api.ts
async function adaptWebHandler(handler, req, res) {
  try {
...
apiRouter.post("/ai/remove-background", (req, res) => {
  return adaptWebHandler(POST6, req, res);
});
apiRouter.post("/packs/:packId/stickers/:slotIndex", (req, res) => {
  return adaptWebHandler(
    (r) => POST2(r, { params: { packId: req.params.packId, slotIndex: req.params.slotIndex } }),
    req,
    res
  );
});
apiRouter.delete("/packs/:packId/stickers/:slotIndex", (req, res) => {
  return adaptWebHandler(
    (r) => DELETE3(r, { params: { packId: req.params.packId, slotIndex: req.params.slotIndex } }),
    req,
    res
  );
});
